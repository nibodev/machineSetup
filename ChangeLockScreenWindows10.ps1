...
Copy-Item -Path "$env:systemroot\Web\Screen\Nibo-Wallpaper-1366x768.png" -Destination "$env:systemroot\Web\Screen\img200.jpg" -Force
Copy-Item -Path "$wallpaperfile" -Destination "$env:systemroot\Web\Screen\Nibo-Wallpaper-1366x768.png" -Force
